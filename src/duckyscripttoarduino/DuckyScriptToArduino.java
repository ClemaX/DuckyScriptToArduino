...
public class DuckyScriptToArduino {
	...
	public static void main(String[] args) {
		...
		+ "\n" + "void sendKey(byte key, byte key2){\n"
				...
				+ "      temp_buf[0] = " + convertToHex("KEY_LEFTSHIFT") + ";//KEY_LEFTSHIFT\n"
				+ "    } else {\n" 
				+ "      switch(buffer[i]){\n"
				+ "        case '%':\n"
				+ "        case ':':\n"
				...
				+ "          temp_buf[0] = " + convertToHex("KEY_RIGHTALT") + ";//KEY_RIGHTALT\n"
				+ "          break;\n" 
				+ "      }\n" 
				+ "    }\n"
				+ "    switch(buffer[i]){\n" 
				+ "      case ' ':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_SPACE") + ";\n"
				+ "        break;\n"
				+ "      case '-':\n"
				+ "      case '_':\n"
				+ "        temp_buf[2] = 0x38;\n"
				...
				+ "      //case '~':\n"
				+ "      //case '¨':\n"
				+ "        sendKey(0x30, " + convertToHex("KEY_LEFTSHIFT") + ");// KEY_TOPDOT //KEY_LEFTSHIFT\n"
				+ "        temp_buf[2] = 0x2C;//send a space to enter the previous ^\n" + "        break;\n"
				+ "      case '=':\n"
				+ "      case '}':\n" 
				+ "      case '0':\n" 
				+ "        temp_buf[2] = " + convertToHex("KEY_0") + ";\n"
				+ "        break;\n" 
				+ "      case '!':\n"
				+ "      case '1':\n" 
				+ "        temp_buf[2] = " + convertToHex("KEY_1") + ";\n"
				+ "        break;\n" 
				+ "      case '\"':\n" 
				+ "      case '@':\n" 
				+ "      case '2':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_2") + ";\n"
				+ "        break;\n" 
				+ "      case '#':\n"
				+ "      case '£':\n"
				+ "      case '3':\n" 
				+ "        temp_buf[2] = " + convertToHex("KEY_3") + ";\n"
				+ "        break;\n" 
				+ "      case '¤':\n"
				+ "      case '$':\n" 
				+ "      case '4':\n" 
				+ "        temp_buf[2] = " + convertToHex("KEY_4") + ";\n"
				+ "        break;\n"
				+ "      case '%':\n" 
				+ "      case '€':\n" 
				+ "      case '5':\n" 
				+ "        temp_buf[2] = " + convertToHex("KEY_5") + ";\n"
				+ "        break;\n" 
				+ "      case '&':\n" 
				+ "      case '6':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_6") + ";\n"
				+ "        break;\n" 
				+ "      case '/':\n"
				+ "      case '{':\n" 
				+ "      case '7':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_7") + ";\n"
				+ "        break;\n" 
				+ "      case '(':\n" 
				+ "      case '[':\n"
				+ "      case '8':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_8") + ";\n"
				+ "        break;\n" 
				+ "      case ')':\n"
				+ "      case ']':\n" 
				+ "      case '9':\n" 
				+ "        temp_buf[2] = " + convertToHex("KEY_9") + ";\n"
				+ "        break;\n"
				+ "      case '\\\'':\n" 
				+ "      case '*':\n" 
				+ "        temp_buf[2] = 0x31;\n"
				...
				+ "      case '<':\n"
				+ "      case '>':\n" 
				+ "        temp_buf[2] = " + convertToHex("KEY_PIPE") + ";\n"
				+ "        break;\n"
				+ "      case ':':\n" 
				+ "      case '.':\n" 
				+ "        temp_buf[2] = " + convertToHex("KEY_DOT") + ";\n"
				+ "        break;\n" 
				+ "      case ',':\n"
				+ "      case ';':\n" 
				+ "        temp_buf[2] = " + convertToHex("KEY_COMMA") + ";\n"
				+ "        break;\n" 
				+ "      case '?':\n"
				+ "      case '+':\n" 
				+ "      case '\\\\':\n"
				...
				+ "      case 'a':\n"
				+ "      case 'A':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_A") + ";\n"
				+ "        break;\n" 
				+ "      case 'b':\n"
				+ "      case 'B':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_B") + ";\n"
				+ "        break;\n"
				+ "      case 'c':\n" 
				+ "      case 'C':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_C") + ";\n"
				+ "        break;\n"
				+ "      case 'd':\n" 
				+ "      case 'D':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_D") + ";\n"
				+ "        break;\n" 
				+ "      case 'e':\n"
				+ "      case 'E':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_E") + ";\n"
				+ "        break;\n" 
				+ "      case 'f':\n" 
				+ "      case 'F':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_F") + ";\n"
				+ "        break;\n" 
				+ "      case 'g':\n"
				+ "      case 'G':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_G") + ";\n"
				+ "        break;\n" 
				+ "      case 'h':\n" 
				+ "      case 'H':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_H") + ";\n"
				+ "        break;\n"
				+ "      case 'i':\n" 
				+ "      case 'I':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_I") + ";\n"
				+ "        break;\n" 
				+ "      case 'j':\n" 
				+ "      case 'J':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_J") + ";\n"
				+ "        break;\n" 
				+ "      case 'k':\n" 
				+ "      case 'K':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_K") + ";\n"
				+ "        break;\n" 
				+ "      case 'l':\n" 
				+ "      case 'L':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_L") + ";\n"
				+ "        break;\n" 
				+ "      case 'm':\n" 
				+ "      case 'M':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_M") + ";\n"
				+ "        break;\n" 
				+ "      case 'n':\n"
				+ "      case 'N':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_N") + ";\n"
				+ "        break;\n"
				+ "      case 'o':\n" 
				+ "      case 'O':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_O") + ";\n"
				+ "        break;\n" 
				+ "      case 'p':\n"
				+ "      case 'P':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_P") + ";\n"
				+ "        break;\n" 
				+ "      case 'q':\n" 
				+ "      case 'Q':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_Q") + ";\n"
				+ "        break;\n" 
				+ "      case 'r':\n" 
				+ "      case 'R':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_R") + ";\n"
				+ "        break;\n" 
				+ "      case 's':\n"
				+ "      case 'S':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_S") + ";\n"
				+ "        break;\n"
				+ "      case 't':\n" 
				+ "      case 'T':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_T") + ";\n"
				+ "        break;\n"
				+ "      case 'u':\n"
				+ "      case 'U':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_U") + ";\n"
				+ "        break;\n" 
				+ "      case 'v':\n"
				+ "      case 'V':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_V") + ";\n"
				+ "        break;\n" 
				+ "      case 'w':\n"
				+ "      case 'W':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_W") + ";\n"
				+ "        break;\n" 
				+ "      case 'x':\n"
				+ "      case 'X':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_X") + ";\n"
				+ "        break;\n" 
				+ "      case 'y':\n"
				+ "      case 'Y':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_Y") + ";\n" 
				+ "        break;\n"
				+ "      case 'z':\n" 
				+ "      case 'Z':\n"
				+ "        temp_buf[2] = " + convertToHex("KEY_Z") + ";\n"
				+ "        break;\n" 
				+ "    }\n"
	...
	private static String convertToHex(String key) {
